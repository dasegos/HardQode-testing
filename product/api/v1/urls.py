...
from api.v1.views.user_view import UserViewSet, SubcriptionViewSet, BalancesViewset

v1_router = DefaultRouter()
v1_router.register('users', UserViewSet, basename='users')
v1_router.register('courses', CourseViewSet, basename='courses')
v1_router.register('subs', SubcriptionViewSet, basename='subs')
v1_router.register('balances', BalancesViewset, basename='balances')
